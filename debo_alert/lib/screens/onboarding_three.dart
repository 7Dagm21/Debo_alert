...
class OnboardingThree extends StatelessWidget {
  ...
  const OnboardingThree({super.key, required this.onToggleTheme});
        ...
        child: Stack(
          children: [
            ...
            _content(
              ...
              desc: 'Join a community dedicated to safety and rapid response',
              dots: 2,
              ...
              onPressed: () {
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute( builder: (_) => SignInScreen(onToggleTheme: onToggleTheme)),
                );
              },
            ),
          ],
